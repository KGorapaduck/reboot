...
erDiagram
    ...
    Course {
        ...
        datetime created_at
        jsonb cohort_analytics "과정 평균 통계 (캐싱)"
    }
    ...
    Lecture {
        ...
        jsonb script_segments "문단별 스크립트 및 키워드 (핀포인트 검색)"
        jsonb checkpoints "강의 중간 질문 및 퀴즈"
        jsonb supplemental_materials "맞춤형 보충 자료 및 성찰 과제 조건"
    }
    ...
    Curriculum {
        ...
        jsonb retention_metrics "이탈 위험도 및 유지 분석 데이터"
    }
    ...
    CurriculumItem {
        ...
        jsonb learning_status "마이크로 시청 기록 및 체크포인트 달성 현황"
        jsonb reflection_data "성찰 과제 제출 및 피드백"
    }
